          ...
          <Form.Row>
            <Form.Group controlId="forName" className="col-lg-8">
              ...
              <Form.Control
                type="text"
                name="name"
                placeholder="Avi Nimni"
                onChange={handleChanges}
                required
              />
              <Form.Text muted>The name can be your real one or a username.</Form.Text>
            </Form.Group>
          ...
          <Form.Row>
            <Form.Group className="col-lg-12">
              ...
              <Form.Control
                ...
                required
              />
              <Form.Text muted>Phone Number should be a valid number.</Form.Text>
            </Form.Group>
          </Form.Row>
          <Form.Row>
          ...
          <Form.Row>
            <Form.Group controlId="formBasicPassword" className="col-lg-6">
              ...
              <Form.Control
                ...
                required
              />
              <Form.Text muted>Your password must be 8-20 characters long</Form.Text>
            </Form.Group>
